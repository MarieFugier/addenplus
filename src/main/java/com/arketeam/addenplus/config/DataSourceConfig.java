...
/*	
    ...
    public DataSource dataSource1() {
        ...
        dataSource.setDriverClassName(env.getProperty("spring.datasource.driver.1"));
    ...
    public DataSource dataSource2() {
        DriverManagerDataSource dataSource = new DriverManagerDataSource();
        dataSource.setDriverClassName(env.getProperty("spring.datasource.driver.2"));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(DataSource dataSource, JpaProperties jpaProperties) {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.arketeam.addenplus.models");
